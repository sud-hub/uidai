...
# Predictive Model: Dropout Risk Classifier - USING FULL DATASET
print("\nBuilding predictive dropout model with FULL DATASET...\n")
...
# District Risk Scoring - WITH FULL DATASET
print("\nGenerating district risk scores from FULL DATASET...\n")
...
print("\n" + "="*80)
print("ANALYSIS COMPLETE - FULL DATASET USED (NO SAMPLING)")
print("="*80)
print(f"Total records analyzed: {len(merged):,}")
print(f"Districts analyzed: {district_risk_summary['district'].nunique()}")
print(f"States analyzed: {district_risk_summary['state'].nunique()}")
print("="*80)
